			...
			<?php echo LayoutHelper::render('joomla.searchtools.default', array('view' => $this)); ?>
				...
				<table class="table table-striped" id="memberList">
					...
					<tr>
						...
						<th class='left'>
							<?php echo HTMLHelper::_('searchtools.sort',  'Mem term', 'a.memberTerm', $listDirn, $listOrder); ?>
						</th>						
						<th class='left'>
					...
					<th scope="col" class="w-3 d-none d-lg-table-cell" >
						...
						<?php echo HTMLHelper::_('searchtools.sort',  'SF ID', 'a.salesforceId', $listDirn, $listOrder); ?>					</th>
					</tr>
					</thead>
					<tfoot>
					<tr>
